...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    $sql_student = "SELECT * FROM student ORDER BY id ASC";
              ...
              <div class="modal-dialog modal-md">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <option value="BPA">Public Administration</option>
                    <option value="BAComm">BA Communication</option>
                    <option value="PolSci">AB Political Science</option>
                    </select>
                    </div>
...
$('#example1 tbody').on('click', '.btn-present', function () {
  ...
  var student_id = $(this).closest("tr").attr('id');
  var $attendance = $(this).closest("tr").children(":eq(6)");
