                    ...
                    <div class="col-md-6">
                        <div class="card card-danger">
                            <div class="card-header">
                                <h3 class="card-title">Violator Information</h3>
                            </div>
                            
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                        <form id ="form_new" action="process_violator.php" method="POST" >
                                          ...
                                          <input type="date" id="selectedDate" name="selectedDate" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="new_stud_no" name="new_stud_no" placeholder="Enter Student Number" required>
                                            </div>

                                            <div class="form-group">
                                                <label>Full Name:</label>
                                                <input type="text" class="form-control" id="new_full_name" name="new_full_name" placeholder="Enter Full Name"
                                                    required>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="new_violation" name="new_violation" required>
                                                  <option selected="0">Choose</option>
                                                    <option value="Bullying">Bullying</option>
                                                    <option value="Long Hair">Long Hair</option>
                                                    <option value="Visible Piercings">Visible Piercings</option>
                                                    <option value="Not wearing uniform">Not wearing proper uniform</option>
                                                    <option value="Vandalism">Vandalism</option>
                                                    <option value="Skipping Classes">Skipping Classes</option>
                                ...
                                <div class="card-footer">
                                    <button type="" class="btn btn-danger" id = "btnAddNewRecord" name="btnAddNewRecord" value = "Add New Record">Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
$(function () {
  $('#form_new').validate({
    ...
    messages: {
      ...
      new_violation: {
        required: "Please provide Violation",
      },
      new_type: {
...
$(document).ready(function() {
  $("#form_new").validate({
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2023 <a href="#">Campus Gate</a>.</strong> All rights reserved.
    </footer>
